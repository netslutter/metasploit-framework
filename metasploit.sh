...
# Sign netslutter repository
curl -fsSL https://raw.githubusercontent.com/neslutter/metasploit-framework/master/netslutter-gpg.pubkey | gpg --dearmor | tee $PREFIX/etc/apt/trusted.gpg.d/netslutter-repo.gpg

# Add netslutter repository to install ruby 2.7.2 version
...
# Set low priority for all netslutter repository (for security purposes)
# Set highest priority for ruby package from netslutter repository
echo '## Set low priority for all netslutter repository (for security purposes)
Package: *
Pin: release netslutter
Pin-Priority: 100
